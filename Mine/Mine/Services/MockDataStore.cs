...
namespace Mine.Services
{
    public class MockDataStore : IDataStore<ItemModel>
    {
        ...
        public bool LoadDefaultData()
        {
            ...
            {
                new ItemModel { Name = "Banana Peel", Description="Causes cart behind to slip.", Value=5 },
                new ItemModel { Name = "Red Shell", Description="Auto-targets the cart in front.", Value=1 },
                new ItemModel { Name = "Triple Red Shell", Description="Three red shells.", Value=3 },
